...
btn = tk.Button(text = "Submit", bd = 2,width =  20 ) # builds a button widget, specifcally for the submission button
btn.config()
...
title = tk.Label(text = "Thanks For Submitting!", font = ("Bebas", 40))
title.config()
title.grid(row = 0, column=1)
